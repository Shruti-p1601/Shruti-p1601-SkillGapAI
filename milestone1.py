...
st.markdown(
    """
    <h2 style='color:white; background-color:#1E3059; padding:15px; border-radius:10px'>
        📘 SkillGapAI - Milestone 1: Data Ingestion & Parsing
    </h2>
...
# ----------------------------------------------------------
# RIGHT SIDE → Parsed output preview
# ----------------------------------------------------------
...
with col2:
    ...
    if uploaded_file:
        ...
        st.info("Upload a file to view parsed output.")
...
if jd_text:
    ...
    st.download_button(
        label="⬇️ Download Cleaned Job Description",
        data=cleaned_jd,
...
st.markdown(
    ...
    Milestone 1 · Data Ingestion & Parsing · SkillGapAI Project  
    </p>
    """,
    unsafe_allow_html=True
)
